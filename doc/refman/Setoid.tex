...
{\tacticdef{setoid\_reflexivity}}

\tacindex{setoid\_symmetry}
{\tacticdef{setoid\_symmetry \zeroone{\texttt{in} \textit{ident}}}}

\tacindex{setoid\_transitivity}
{\tacticdef{setoid\_transitivity}}

\tacindex{setoid\_rewrite}
{\tacticdef{setoid\_rewrite \textit{term} ~\zeroone{\texttt{in} \textit{ident}}}}

{\tacticdef{setoid\_rewrite <- \textit{term} ~\zeroone{\texttt{in} \textit{ident}}}}

{\tacticdef{setoid\_rewrite <- \textit{term} ~\zeroone{{\tt at} \textit{occs}} ~\zeroone{\texttt{in} \textit{ident}}}}

{\tacticdef{setoid\_rewrite \zeroone{\textit{orientation}} \textit{term}
~\zeroone{{\tt at} \textit{occs}} ~\zeroone{\texttt{in} \textit{ident}}}}

\tacindex{setoid\_replace}
{\tacticdef{setoid\_replace \textit{term} \texttt{with} \textit{term}}}
...
The {\vernacdef{Print Instances \argchoice{Reflexive,Symmetric,Transitive,Equivalence,PreOrder,PER,Proper}}} command can be used to show the list of
...
Morphisms (implemented as \texttt{Proper} instances). More generally, the command \vernacdef{Print Instances \nterm{typeclass}} will print all defined instances of \nterm{typeclass}. When
...
{\tacticdef{rewrite\_strat ~\textit{s}~\zeroone{\texttt{in} \textit{ident}}}}:
