...
The {\tacticdef{ring}} tactic solves equations upon polynomial expressions of
...
{\tacticdef{ring\_simplify}} applies the normalization procedure described
...
\begin{Variants}
  \item {\tacticdef{ring [\term$_1$ {\ldots} \term$_n$]}} decides the equality of two
  ...
  \item {\tacticdef{ring\_simplify [\term$_1$ {\ldots} \term$_n$] \nterm{t}$_1$ \ldots \nterm{t}$_m$ in
{\ident}}}
...
The syntax for adding a new ring is {\vernacdef{Add Ring \nterm{name} : \nterm{ring}
(\nterm{mod}$_1$,\dots,\nterm{mod}$_2$)}}.  The name is not relevant. It is just used
for error messages. The term \nterm{ring} is a proof that the ring signature
...
The {\tacticdef{field}} tactic is  an extension of the {\tt ring} to deal with
...
\begin{Variants}
  \item {\tacticdef{field [\term$_1$ {\ldots} \term$_n$]}} decides the equality of two
  ...
  \item {\tacticdef{field\_simplify   [\term$_1$ {\ldots} \term$_n$]}}
     performs the simplification in the conclusion of the goal using
    the equalities
    defined by \term$_1$ {\ldots} \term$_n$.

  \item {\tacticdef{field\_simplify   [\term$_{a_1}$ {\ldots} \term$_{a_n}$] \term$_{b_1}$ \ldots
\term$_{b_m}$}}
     performs the simplification in the terms \term$_{b_1}$ \ldots \term$_{b_m}$
    of the conclusion of the goal using
    the equalities
    defined by \term$_{a_1}$ {\ldots} \term$_{a_n}$.

  \item {\tacticdef{field\_simplify in \hyp}}
     performs the simplification in the assumption \hyp.

  \item {\tacticdef{field\_simplify   [\term$_1$ {\ldots} \term$_n$] in \hyp}}
     performs the simplification in the assumption \hyp using
    the equalities
    defined by \term$_1$ {\ldots} \term$_n$. 
...
\term$_{b_m}$ in \hyp}}
     performs the simplification in the terms \term$_{b_1}$ \ldots \term$_{b_m}$
    of the assumption \hyp using
    the equalities
    defined by \term$_{a_1}$ {\ldots} \term$_{a_n}$.

  \item {\tacticdef{field\_simplify\_eq}}
     performs the simplification in the conclusion of the goal removing
     the denominator. $F_1 = F_2$
     becomes $N_1 D_2 = N_2  D_1$.

  \item {\tacticdef{field\_simplify\_eq   [\term$_1$ {\ldots} \term$_n$]}}
     performs the simplification in the conclusion of the goal using
    the equalities
    defined by \term$_1$ {\ldots} \term$_n$. 

  \item {\tacticdef{field\_simplify\_eq in \hyp}}
     performs the simplification in the assumption $\hyp$.

  \item {\tacticdef{field\_simplify\_eq  [\term$_1$ {\ldots} \term$_n$] in \hyp}}
     performs the simplification in the assumption \hyp using
    the equalities
    defined by \term$_1$ {\ldots} \term$_n$. 
\end{Variants}
...
The syntax for adding a new field is {\vernacdef{Add Field \nterm{name} : \nterm{field}
(\nterm{mod}$_1$,\dots,\nterm{mod}$_2$)}}.  The name is not relevant. It is just used
for error messages. \nterm{field} is a proof that the field signature
