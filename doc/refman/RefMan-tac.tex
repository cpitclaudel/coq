...
\subsection[\tt Set Default Goal Selector ``{\selector}''.]
           {\vernacdef{Set Default Goal Selector ``{\selector}''.
...
the first goal. Using {\vernacdef{Set Default Goal Selector ``all''}} will
...
\subsection[\tt Test Default Goal Selector.]
           {\vernacdef{Test Default Goal Selector.}}
...
\begin{Variants}
  \item {\tacticdef{eexact \term}}\tacindex{eexact}
...
\subsection{\tacticdef{assumption}}
\tacindex{assumption}
...
\subsection{\tacticdef{refine \term}}
\tacindex{refine}
\label{refine}
...
\item{\tacticdef{apply {\term} with {\term$_1$} \dots\ {\term$_n$}}}
...
\item{\tacticdef{apply {\term} with ({\vref$_1$} := {\term$_1$}) \dots\ ({\vref$_n$}
    := {\term$_n$})}}
...
\item {\tacticdef{apply \term$_1$ , \mbox{\dots} , \term$_n$}}
...
\item {\tacticdef{eapply \term}}\tacindex{eapply}
...
\item {\tacticdef{simple apply {\term}}} \tacindex{simple apply}
...
\item {\tacticdef{lapply {\term}}} \tacindex{lapply}
...
{\vernacdef{Set Universal Lemma Under Conjunction}}
\end{quote}
...
\subsection{\tacticdef{apply {\term} in {\ident}}}
\label{apply-in}
...
\item {\tacticdef{simple apply {\term} in {\ident}}}
...
\subsection{\tacticdef{constructor \num}}
\label{constructor}
\tacindex{constructor}
...
\item {\tacticdef{split}}\tacindex{split}
...
\item {\tacticdef{exists {\bindinglist}}}\tacindex{exists}
...
\item {\tacticdef{exists \nelist{\bindinglist}{,}}}

  This iteratively applies {\tt exists {\bindinglist}}.

\item {\tacticdef{left}}\tacindex{left}\\
      {\tacticdef{right}}\tacindex{right}
...
\item {\tacticdef{left with \bindinglist}}\\
      {\tacticdef{right with \bindinglist}}\\
      {\tacticdef{split with \bindinglist}}
...
\item {\tacticdef{econstructor}}\tacindex{econstructor}\\
      {\tacticdef{eexists}}\tacindex{eexists}\\
      {\tacticdef{esplit}}\tacindex{esplit}\\
      {\tacticdef{eleft}}\tacindex{eleft}\\
      {\tacticdef{eright}}\tacindex{eright}
...
\item {\tacticdef{intros \ident$_1$ \dots\ \ident$_n$}}
...
\item {\tacticdef{intros until {\ident}}} \tacindex{intros until}
...
\item {\tacticdef{intro after \ident}} \tacindex{intro after}\\
      {\tacticdef{intro before \ident}} \tacindex{intro before}\\
      {\tacticdef{intro at top}} \tacindex{intro at top}\\
      {\tacticdef{intro at bottom}} \tacindex{intro at bottom}
...
\item {\tacticdef{intro \ident$_1$ after \ident$_2$}}\\
      {\tacticdef{intro \ident$_1$ before \ident$_2$}}\\
      {\tacticdef{intro \ident$_1$ at top}}\\
      {\tacticdef{intro \ident$_1$ at bottom}}
...
\subsection{\tacticdef{intros {\intropatternlist}}}
...
\item {\tacticdef{clear {\ident$_1$} \dots\ {\ident$_n$}}}

  This is equivalent to {\tt clear {\ident$_1$}. {\ldots} clear
    {\ident$_n$}.}

\item {\tacticdef{clearbody {\ident}}}\tacindex{clearbody}
...
\item {\tacticdef{clear dependent \ident \tacindex{clear dependent}}}
...
\subsection{\tacticdef{revert \ident$_1$ \dots\ \ident$_n$}}
\tacindex{revert}
\label{revert}
...
\begin{Variants}
\item {\tacticdef{revert dependent \ident \tacindex{revert dependent}}}
...
\subsection{\tacticdef{move {\ident$_1$} after {\ident$_2$}}}
\tacindex{move}
\label{move}
...
\subsection{\tacticdef{rename {\ident$_1$} into {\ident$_2$}}}
\tacindex{rename}
...
\item {\tacticdef{rename {\ident$_1$} into {\ident$_2$}, \ldots,
...
\subsection{\tacticdef{set ( {\ident} := {\term} )}}
\label{tactic:set}
\tacindex{set}
...
\item {\tacticdef{set ( {\ident} := {\term} ) in {\occgoalset}}}
...
\subsection{\tacticdef{decompose [ {\qualid$_1$} \dots\ {\qualid$_n$} ] \term}}
\label{decompose}
\tacindex{decompose}
...
\item {\tacticdef{decompose sum \term}}\tacindex{decompose sum}

  This decomposes sum types (like \texttt{or}).

\item {\tacticdef{decompose record \term}}\tacindex{decompose record}
...
\subsection{\tacticdef{assert ( {\ident} :\ {\form} )}}
\tacindex{assert}
...
\item{\tacticdef{assert {\form}}}

  This behaves as {\tt assert ( {\ident} :\ {\form} )} but
  {\ident} is generated by {\Coq}.

\item {\tacticdef{assert {\form} by {\tac}}}\tacindex{assert by}
...
\item {\tacticdef{assert {\form} as {\intropattern}\tacindex{assert as}}}
...
\item {\tacticdef{assert {\form} as {\intropattern} by {\tac}}}

  This combines the two previous variants of {\tt assert}.

\item{\tacticdef{assert ( {\ident} := {\term} )}}
...
\item {\tacticdef{pose proof {\term} as {\intropattern}\tacindex{pose proof}}}
...
\item {\tacticdef{enough ({\ident} :\ {\form})}}\tacindex{enough}
...
\item {\tacticdef{enough {\form}}}\tacindex{enough}

  This behaves like \texttt{enough ({\ident} :\ {\form})} with the name
  {\ident} of the hypothesis generated by {\Coq}.

\item {\tacticdef{enough {\form} as {\intropattern}\tacindex{enough as}}}

  This behaves like \texttt{enough} {\form} using {\intropattern} to
  name or destruct the new hypothesis.

\item {\tacticdef{enough ({\ident} :\ {\form}) by {\tac}}}\tacindex{enough by}\\
 {\tacticdef{enough {\form} by {\tac}}}\tacindex{enough by}\\
 {\tacticdef{enough {\form} as {\intropattern} by {\tac}}}
...
\item {\tacticdef{cut {\form}}}\tacindex{cut}
...
\item {\tacticdef{specialize ({\ident} \term$_1$ \dots\ \term$_n$)\tacindex{specialize}}} \\
      {\tacticdef{specialize {\ident} with \bindinglist}}
...
\subsection{\tacticdef{generalize \term}}
\tacindex{generalize}
\label{generalize}
...
\item {\tacticdef{generalize dependent \term}} \tacindex{generalize dependent}
...
\subsection{\tacticdef{evar ( {\ident} :\ {\term} )}}
\tacindex{evar}
\label{evar}
...
\subsection{\tacticdef{instantiate ( {\num} := {\term} )}}
\tacindex{instantiate}
\label{instantiate}
...
\subsection{\tacticdef{absurd \term}}
\tacindex{absurd}
\label{absurd}
...
\subsection{\tacticdef{contradiction}}
\label{contradiction}
...
\begin{Variants}
\item {\tacticdef{contradiction \ident}}

The proof of {\tt False} is searched in the hypothesis named \ident.
\end{Variants}

\subsection{\tacticdef{contradict \ident}}
\label{contradict}
\tacindex{contradict}
...
\subsection{\tacticdef{destruct \term}}
\tacindex{destruct}
\label{destruct}
...
\begin{Variants}
\item{\tacticdef{destruct \term$_1$, \ldots, \term$_n$}}

  This is a shortcut for {\tt destruct \term$_1$; \ldots; destruct \term$_n$}.

\item{\tacticdef{destruct {\term} as {\disjconjintropattern}}}
...
\item{\tacticdef{destruct {\term} eqn:{\namingintropattern}}}
...
\item{\tacticdef{destruct {\term} with \bindinglist}}
...
\item{\tacticdef{edestruct {\term}\tacindex{edestruct}}}
...
\item{\tacticdef{destruct {\term$_1$} using {\term$_2$}}}\\
     {\tacticdef{destruct {\term$_1$} using {\term$_2$} with {\bindinglist}}}

  These are synonyms of {\tt induction {\term$_1$} using {\term$_2$}} and
  {\tt induction {\term$_1$} using {\term$_2$} with {\bindinglist}}.

\item {\tacticdef{destruct {\term} in {\occgoalset}}}
...
\item{\tacticdef{destruct {\term$_1$} with {\bindinglist$_1$}
        as {\disjconjintropattern} eqn:{\namingintropattern}
        using {\term$_2$} with {\bindinglist$_2$} in {\occgoalset}}}\\
     {\tacticdef{edestruct {\term$_1$} with {\bindinglist$_1$}
        as {\disjconjintropattern} eqn:{\namingintropattern}
        using {\term$_2$} with {\bindinglist$_2$} in {\occgoalset}}}
...
\item{\tacticdef{case \term}}\label{case}\tacindex{case}
...
\item {\tacticdef{case {\term} with {\bindinglist}}}

  Analogous to {\tt elim {\term} with {\bindinglist}} above.

\item{\tacticdef{ecase {\term}\tacindex{ecase}}}\\
  {\tacticdef{ecase {\term} with {\bindinglist}}}
...
\item{\tacticdef{case\_eq \term}}\label{case_eq}\tacindex{case\_eq}
...
\subsection{\tacticdef{induction \term}}
\tacindex{induction}
\label{Tac-induction}
...
\begin{Variants}
\item{\tacticdef{induction {\term} as {\disjconjintropattern}}}
...
\item{\tacticdef{induction {\term} with \bindinglist}}
...
\item{\tacticdef{einduction {\term}\tacindex{einduction}}}
...
\item {\tacticdef{induction {\term$_1$} using {\term$_2$}}}
...
\item {\tacticdef{induction {\term$_1$} using {\term$_2$} with {\bindinglist}}}

  This behaves as {\tt induction {\term$_1$} using {\term$_2$}} but
  also providing instances for the premises of the type of {\term$_2$}.

\item {\tacticdef{induction {\term}$_1$, {\ldots}, {\term}$_n$ using {\qualid}}}
...
\item {\tacticdef{induction {\term} in {\occgoalset}}}
...
\item {\tacticdef{induction {\term$_1$} with {\bindinglist$_1$}
       as {\disjconjintropattern} %% eqn:{\namingintropattern}
       using {\term$_2$} with {\bindinglist$_2$} in {\occgoalset}}}\\
     {\tacticdef{einduction {\term$_1$} with {\bindinglist$_1$}
       as {\disjconjintropattern} %% eqn:{\namingintropattern}
       using {\term$_2$} with {\bindinglist$_2$} in {\occgoalset}}}
...
\item {\tacticdef{elim \term}}\label{elim}
...
\item {\tacticdef{elim {\term} with {\bindinglist}}}

  Allows to give explicit instances to the premises of the type
  of {\term} (see Section~\ref{Binding-list}).

\item{\tacticdef{eelim {\term}\tacindex{eelim}}}

  In case the type of {\term} has dependent premises, this turns them into
  existential variables to be resolved later on.

\item{\tacticdef{elim {\term$_1$} using {\term$_2$}}}\\
     {\tacticdef{elim {\term$_1$} using {\term$_2$} with {\bindinglist}\tacindex{elim \dots\ using}}}
...
\item{\tacticdef{elim {\term$_1$} with {\bindinglist$_1$} using {\term$_2$} with {\bindinglist$_2$}}}\\
     {\tacticdef{eelim {\term$_1$} with {\bindinglist$_1$} using {\term$_2$} with {\bindinglist$_2$}}}
...
\item {\tacticdef{elimtype \form}}\tacindex{elimtype}
...
\item {\tacticdef{simple induction \ident}}\tacindex{simple induction}

  This tactic behaves as {\tt intros until
    {\ident}; elim {\tt {\ident}}} when {\ident} is a quantified
  variable of the goal.

\item {\tacticdef{simple induction {\num}}}
...
%% \item {\tacticdef{simple induction {\term}}}\tacindex{simple induction}
...
%\subsection[\tt FixPoint \dots]{\vernacdef{FixPoint \dots\tacindex{Fixpoint}}}
%Not yet documented.

\subsection{\tacticdef{double induction \ident$_1$ \ident$_2$}}
...
\item {\tacticdef{double induction \num$_1$ \num$_2$}}
...
\subsection{\tacticdef{dependent induction \ident}}
...
\begin{Variants}
\item {\tacticdef{dependent induction {\ident} generalizing {\ident$_1$} \dots
...
\item {\tacticdef{dependent destruction {\ident}}}\tacindex{dependent destruction}
...
\subsection{\tacticdef{functional induction (\qualid\ \term$_1$ \dots\ \term$_n$)}}
...
\begin{Variants}
\item {\tacticdef{functional induction (\qualid\ \term$_1$ \dots\ \term$_n$)
...
\subsection{\tacticdef{discriminate \term}}
\label{discriminate}
...
\item {\tacticdef{discriminate {\term} with \bindinglist}}
...
\item {\tacticdef{ediscriminate \num}}\tacindex{ediscriminate}\\
      {\tacticdef{ediscriminate {\term} \zeroone{with \bindinglist}}}
...
\subsection{\tacticdef{injection \term}}
\label{injection}
\tacindex{injection}
...
\begin{Variants}
\item {\tacticdef{injection \num}}

  This does the same thing as \texttt{intros until \num} followed by
\texttt{injection \ident} where {\ident} is the identifier for the last
introduced hypothesis.

\item {\tacticdef{injection {\term} with \bindinglist}}

  This does the same as \texttt{injection {\term}} but using
  the given bindings to instantiate parameters or hypotheses of {\term}.

\item {\tacticdef{einjection \num}}\tacindex{einjection}\\
      {\tacticdef{einjection {\term} \zeroone{with \bindinglist}}}
...
\item {\tacticdef{injection {\term} \zeroone{with \bindinglist} as \nelistnosep{\intropattern}}}\\
{\tacticdef{injection {\num} as {\intropattern} \dots\ \intropattern}}\\
{\tacticdef{injection as {\intropattern} \dots\ \intropattern}}\\
{\tacticdef{einjection {\term} \zeroone{with \bindinglist} as \nelistnosep{\intropattern}}}\\
{\tacticdef{einjection {\num} as {\intropattern} \dots\ \intropattern}}\\
{\tacticdef{einjection as {\intropattern} \dots\ \intropattern}}
...
\subsection{\tacticdef{inversion \ident}}
\tacindex{inversion}
...
\begin{Variants}
\item {\tacticdef{inversion \num}}

  This does the same thing as \texttt{intros until \num} then
  \texttt{inversion \ident} where {\ident} is the identifier for the
  last introduced hypothesis.

\item \tacindex{inversion\_clear} {\tacticdef{inversion\_clear \ident}}

  This behaves as \texttt{inversion} and then erases \ident~ from the
  context.

\item \tacindex{inversion \dots\ as} {\tacticdef{inversion {\ident} as \intropattern}}
...
\item \tacindex{inversion\_clear \dots\ as} {\tacticdef{inversion\_clear
...
\item \tacindex{inversion \dots\ in} {\tacticdef{inversion {\ident}
...
\item \tacindex{inversion \dots\ as \dots\ in} {\tacticdef{inversion
...
\item \tacindex{inversion\_clear \dots\ in} {\tacticdef{inversion\_clear
...
\item \tacindex{inversion\_clear \dots\ as \dots\ in}
  {\tacticdef{inversion\_clear {\ident} as {\intropattern}
  in \ident$_1$ \dots\ \ident$_n$}}

  This allows naming the hypotheses introduced in the context by
  \texttt{inversion\_clear {\ident} in \ident$_1$ \dots\ \ident$_n$}.

\item \tacindex{dependent inversion} {\tacticdef{dependent inversion \ident}}
...
\item \tacindex{dependent inversion \dots\ as } {\tacticdef{dependent
    inversion {\ident} as \intropattern}}

  This allows naming the hypotheses introduced in the context by
  \texttt{dependent inversion} {\ident}.

\item \tacindex{dependent inversion\_clear} {\tacticdef{dependent
...
\item \tacindex{dependent inversion\_clear \dots\ as}
  {\tacticdef{dependent inversion\_clear {\ident} as \intropattern}}

  This allows naming the hypotheses introduced in the context by
  \texttt{dependent inversion\_clear} {\ident}.

\item \tacindex{dependent inversion \dots\ with} {\tacticdef{dependent
...
\item \tacindex{dependent inversion \dots\ as \dots\ with}
  {\tacticdef{dependent inversion {\ident} as {\intropattern}
  with \term}}

  This allows naming the hypotheses introduced in the context by
  {\tacticdef{dependent inversion {\ident} with \term}}.

\item \tacindex{dependent inversion\_clear \dots\ with}
  {\tacticdef{dependent inversion\_clear {\ident} with \term}}

  Like \texttt{dependent inversion \dots\ with} but clears {\ident} from
  the local context.

\item \tacindex{dependent inversion\_clear \dots\ as \dots\ with}
  {\tacticdef{dependent inversion\_clear {\ident} as
  {\intropattern} with \term}}

  This allows naming the hypotheses introduced in the context by
  \texttt{dependent inversion\_clear {\ident} with \term}.

\item \tacindex{simple inversion} {\tacticdef{simple inversion \ident}}

  It is a very primitive inversion tactic that derives all the necessary
  equalities  but it does not simplify the  constraints as
  \texttt{inversion} does.

\item \tacindex{simple inversion \dots\ as} {\tacticdef{simple inversion
  {\ident} as \intropattern}}

  This allows naming the hypotheses introduced in the context by
  \texttt{simple inversion}.

\item \tacindex{inversion \dots\ using} {\tacticdef{inversion {\ident}
  using \ident$'$}}
...
\item \tacindex{inversion \dots\ using \dots\ in} {\tacticdef{inversion
...
\subsection{\tacticdef{cofix \ident}}
\tacindex{cofix}
\label{tactic:cofix}
...
\begin{Variants}
  \item {\tacticdef{cofix \ident$_1$ with ( \ident$_2$
...
\subsection{\tacticdef{rewrite \term}}
\label{rewrite}
\tacindex{rewrite}
...
\begin{Variants}
\item {\tacticdef{rewrite -> \term}}\tacindex{rewrite ->}
...
\item {\tacticdef{rewrite {\term} at {\occlist}}}
...
\item {\tacticdef{erewrite {\term}\tacindex{erewrite}}}
...
\subsection{\tacticdef{replace \term$_1$ with \term$_2$}}
...
\item {\tacticdef{replace {\term$_1$} with {\term$_2$} in \nterm{clause} }}\\
    {\tacticdef{replace {\term$_1$} with {\term$_2$} in \nterm{clause} by \tac }}\\
    {\tacticdef{replace {\term} in \nterm{clause}}}\\
    {\tacticdef{replace -> {\term} in \nterm{clause}}}\\
    {\tacticdef{replace <- {\term} in \nterm{clause}}}
...
\item {\tacticdef{cutrewrite <- (\term$_1$ = \term$_2$)}}
%\label{cutrewrite}
\tacindex{cutrewrite}
...
\subsection{\tacticdef{subst \ident}}
\tacindex{subst}
...
\begin{Variants}
  \item {\tacticdef{subst \ident$_1$ \dots \ident$_n$}}
...
\begin{Variants}
\item{\tacticdef{stepl {\term} by {\tac}}}

This applies {\tt stepl {\term}} then applies {\tac} to the second goal.

\item{\tacticdef{stepr {\term}}}\\
     {\tacticdef{stepr {\term} by {\tac}}}\tacindex{stepr}
...
\begin{quote}
{\vernacdef{Declare Right Step {\term}.}}
\end{quote}
\end{Variants}

\subsection{\tacticdef{change \term}}
\tacindex{change}
\label{change}
...
\item {\tacticdef{change {\term} in {\ident}}}

\item {\tacticdef{change \term$_1$ with \term$_2$ in {\ident}}}
...
\subsection{{\tacticdef{cbv \flag$_1$ \mbox{\dots} \flag$_n$}}, {\tacticdef{lazy \flag$_1$
\mbox{\dots} \flag$_n$}}, and {\tacticdef{compute}}}
\tacindex{cbv}
\tacindex{lazy}
\tacindex{compute}
...
\begin{Variants}
\item {\tacticdef{compute}} \tacindex{compute}\\
      {\tacticdef{cbv}}
...
\item {\tacticdef{compute [\qualid$_1$\ldots\qualid$_k$]}}\\
      {\tacticdef{cbv [\qualid$_1$\ldots\qualid$_k$]}}
...
\item {\tacticdef{lazy [\qualid$_1$\ldots\qualid$_k$]}}\\
      {\tacticdef{lazy -[\qualid$_1$\ldots\qualid$_k$]}}

  These are respectively synonyms of {\tt lazy beta delta
  [\qualid$_1$\ldots\qualid$_k$] iota zeta} and {\tt lazy beta delta
  -[\qualid$_1$\ldots\qualid$_k$] iota zeta}.

\item {\tacticdef{vm\_compute}} \tacindex{vm\_compute}
...
\item {\tacticdef{native\_compute}} \tacindex{native\_compute}
...
\subsection{\texorpdfstring{{\tacticdef{cbn}}}{cbn} and \texorpdfstring{{\tacticdef{simpl}}}{simpl}}
...
\begin{itemize}
\item \vernacdef{Arguments {\ident} \nelistnosep{\possiblybracketedident} : simpl never}\\
...
\item \vernacdef{Arguments {\ident} \nelistnosep{\possiblybracketedident} / \nelistnosep{\possiblybracketedident}}\\
...
\item \vernacdef{Arguments {\ident} \nelistnosep{\possiblybracketedident} : simpl nomatch}\\
...
\begin{Variants}
\item {\tacticdef{cbn [\qualid$_1$\ldots\qualid$_k$]}}\\
      {\tacticdef{cbn -[\qualid$_1$\ldots\qualid$_k$]}}
...
\item {\tacticdef{simpl {\qualid}}}\\
  {\tacticdef{simpl {\qstring}}}
...
\item {\tacticdef{simpl {\qualid} at \num$_1$ \dots\ \num$_i$}}\\
  {\tacticdef{simpl {\qstring} at \num$_1$ \dots\ \num$_i$}}\\
...
\subsection{\tacticdef{unfold \qualid}}
\tacindex{unfold}
\label{unfold}
...
\begin{Variants}
\item {\tacticdef{unfold {\qualid}$_1$, \dots, \qualid$_n$}}
...
\item {\tacticdef{unfold {\qualid}$_1$ at \num$_1^1$, \dots, \num$_i^1$,
\dots,\ \qualid$_n$ at \num$_1^n$, \dots, \num$_j^n$}}
...
\item {\tacticdef{unfold {\qstring}\%{\delimkey}}}
...
\item {\tacticdef{unfold \qualidorstring$_1$ at \num$_1^1$, \dots, \num$_i^1$,
...
\begin{Variants}
\item {\tacticdef{fold}} \term$_1$ \dots\ \term$_n$

  Equivalent to {\tt fold} \term$_1${\tt;}\ldots{\tt; fold} \term$_n$.
\end{Variants}

\subsection{\tacticdef{pattern \term}}
\tacindex{pattern}
\label{pattern}
...
\item {\tacticdef{pattern {\term$_1$}, \dots, {\term$_m$}}}
...
\item {\tacticdef{pattern {\term$_1$} at {\num$_1^1$} \dots\ {\num$_{n_1}^1$}, \dots,
    {\term$_m$} at {\num$_1^m$} \dots\ {\num$_{n_m}^m$}}}
...
\item {\tacticdef{pattern}} {\term$_1$} \zeroone{{\tt at \zeroone{-}} {\num$_1^1$} \dots\ {\num$_{n_1}^1$}} {\tt ,} \dots {\tt ,}
...
\item {\tacticdef{auto with \ident$_1$ \dots\ \ident$_n$}}
...
\subsection{\tacticdef{autounfold with \ident$_1$ \mbox{\dots} \ident$_n$}}
\tacindex{autounfold}
\label{autounfold}
...
\begin{Variants}
\item {\tacticdef{autounfold with \ident$_1$ \dots\ \ident$_n$ in \nterm{clause}}}

  Performs the unfolding in the given clause.

\item {\tacticdef{autounfold with *}}

  Uses the unfold hints declared in all the hint databases.
\end{Variants}


\subsection{\tacticdef{autorewrite with \ident$_1$ \mbox{\dots} \ident$_n$}}
...
\begin{Variant}
\item {\tacticdef{autorewrite with \ident$_1$ \mbox{\dots} \ident$_n$ using \tac}}
...
\item {\tacticdef{autorewrite with \ident$_1$ \mbox{\dots} \ident$_n$ in \qualid}}

  Performs all the rewritings in hypothesis {\qualid}.
\item {\tacticdef{autorewrite with \ident$_1$ \mbox{\dots} \ident$_n$ in {\qualid} using \tac}}

  Performs all  the rewritings  in hypothesis {\qualid}  applying {\tt
    \tac} to the main subgoal after each rewriting step.

\item {\tacticdef{autorewrite with \ident$_1$ \mbox{\dots} \ident$_n$ in \nterm{clause}}}
...
\medskip
{\vernacdef{Create HintDb {\ident} \zeroone{\texttt{discriminated}}}}
\medskip
...
\begin{tabbing}
  {\vernacdef{Hint {\hintdef} :~\ident$_1$ \mbox{\dots} \ident$_n$}}
\end{tabbing}

\begin{Variants}
\item {\vernacdef{Hint \hintdef}}

  No database name is given: the hint is registered in the {\tt core}
    database.

\item {\vernacdef{Local Hint {\hintdef} :~\ident$_1$ \mbox{\dots} \ident$_n$}}
...
\item {\vernacdef{Local Hint \hintdef}}
...
%%  \item \errindex{Bound head variable}
  ...
  \item \cchintdef{Resolve \term$_1$ \mbox{\dots} \term$_m$}

    Adds each \texttt{Resolve} {\term$_i$}.

  \end{Variants}

\item \cchintdef{Immediate {\term}}
...
%%  \item \errindex{Bound head variable}
  ...
  \begin{Variants}
    ...
    \item \cchintdef{Immediate \term$_1$ \mbox{\dots} \term$_m$}

      Adds each \texttt{Immediate} {\term$_i$}.

  \end{Variants}

\item \cchintdef{Constructors {\ident}}
...
%%    \item {\ident} \errindex{not declared}
  ...
  \begin{Variants}
    ...
    \item \cchintdef{Constructors \ident$_1$ \mbox{\dots} \ident$_m$}

      Adds each \texttt{Constructors} {\ident$_i$}.

  \end{Variants}

\item \cchintdef{Unfold {\qualid}}
\comindex{Hint Unfold}
  ...
  \begin{Variants}
    ...
    \item \cchintdef{Unfold \ident$_1$ \mbox{\dots} \ident$_m$}

      Adds each \texttt{Unfold} {\ident$_i$}.

  \end{Variants}

\item \cchintdef{\argchoice{Transparent,Opaque} \qualid}
...
\comindex{Hint Opaque}
  ...
  \begin{Variants}
    ...
    \item \cchintdef{\argchoice{Transparent,Opaque} {\ident$_1$} \mbox{\dots} {\ident$_m$}}

      Declares each {\ident$_i$} as a transparent or opaque constant.

  \end{Variants}

\item \cchintdef{Extern \num\ \zeroone{\pattern} => \textsl{tactic}}
...
\item \cchintdef{\texttt{Cut} {\textit{regexp}}}
\label{HintCut}
\comindex{Hint Cut}
...
\item {\vernacdef{Hint Local {\hintdef} : \ident$_1$ \mbox{\dots} \ident$_n$}}
...
\item {\vernacdef{Hint Local \hintdef}}
...
\subsection{\vernacdef{Remove Hints \term$_1$ \mbox{\dots} \term$_n$ :~ \ident$_1$
  \mbox{\dots} \ident$_m$}}
\label{RemoveHints}
...
\subsection{\vernacdef{Print Hint}}
\label{PrintHint}
\comindex{Print Hint}
...
\item {\vernacdef{Print Hint \ident}}
...
\item {\vernacdef{Print Hint *}}

  This command displays all declared hints.

\item {\vernacdef{Print HintDb \ident}}
\label{PrintHintDb}
...
\subsection{\vernacdef{Hint Rewrite \term$_1$ \mbox{\dots} \term$_n$ :~ \ident$_1$ \mbox{\dots} \ident$_m$}}
\label{HintRewrite}
...
\begin{Variants}
\item {\vernacdef{Hint Rewrite -> \term$_1$ \mbox{\dots} \term$_n$ :~\ident$_1$ \mbox{\dots} \ident$_m$}}
...
\item {\vernacdef{Hint Rewrite \term$_1$ \mbox{\dots} \term$_n$ using {\tac} :~\ident$_1$ \mbox{\dots} \ident$_m$}}
...
\item {\vernacdef{Print Rewrite HintDb {\ident}}}
...
\item {\vernacdef{Set Loose Hint Behavior "Lax"}}
...
\item {\vernacdef{Set Loose Hint Behavior "Warn"}}
...
\item {\vernacdef{Set Loose Hint Behavior "Strict"}}
...
\subsubsection{\vernacdef{Proof with {\tac}}}
\label{ProofWith}
\comindex{Proof with}
...
\item {\vernacdef{Proof with {\tac} using \ident$_1$ \mbox{\dots} \ident$_n$}}

  Combines in a single line {\tt Proof with} and {\tt Proof using},
  see~\ref{ProofUsing}

\item {\vernacdef{Proof using \ident$_1$ \mbox{\dots} \ident$_n$ with {\tac}}}
...
\subsubsection{\vernacdef{Declare Implicit Tactic {\tac}}}\label{DeclareImplicit}
...
\subsection{\tacticdef{intuition \tac}}
\tacindex{intuition}
\tacindex{dintuition}
\label{intuition}
...
\begin{Variants}
\item {\tacticdef{intuition}}

  Is equivalent to {\tt intuition auto with *}.

\item {\tacticdef{dintuition}}
...
\begin{quote}
{\vernacdef{Unset Intuition Negation Unfolding}}
\end{quote}
...
\begin{quote}
{\vernacdef{Set Intuition Negation Unfolding}}
\end{quote}
...
\begin{quote}
{\vernacdef{Unset Intuition Iff Unfolding}}
\end{quote}
...
\begin{quote}
{\vernacdef{Set Intuition Iff Unfolding}}
\end{quote}
...
\subsection{\tacticdef{firstorder}}
\tacindex{firstorder}
\label{firstorder}
...
The default tactic used by \texttt{firstorder} when no rule applies is {\tt
  ...
  {\vernacdef{Set Firstorder Solver {\tac}}}} \optindex{Firstorder Solver}
vernacular command and printed using {\nobreak {\vernacdef{Print Firstorder
    Solver}}}.

\begin{Variants}
 \item {\tacticdef{firstorder {\tac}}}
   \tacindex{firstorder {\tac}}

   Tries to solve the goal with {\tac} when no logical rule may apply.

 \item {\tacticdef{firstorder with \ident$_1$ \dots\ \ident$_n$ }}
   \tacindex{firstorder with}

   Adds lemmas \ident$_1$ \dots\ \ident$_n$ to the proof-search
   environment.

 \item {\tacticdef{firstorder using {\qualid}$_1$ , \dots\ , {\qualid}$_n$ }}
...
\item {\tacticdef{firstorder using {\qualid}$_1$ , \dots\ , {\qualid}$_n$ with \ident$_1$ \dots\ \ident$_n$}}
...
{\vernacdef{Set Firstorder Depth $n$}} \optindex{Firstorder Depth}
vernacular command.


\subsection{\tacticdef{congruence}}
\tacindex{congruence}
\label{congruence}
...
\item {\tacticdef{congruence with \term$_1$ \dots\ \term$_n$}}
...
\subsection{\tacticdef{constr\_eq \term$_1$ \term$_2$}}
\tacindex{constr\_eq}
\label{constreq}
...
\subsection{\tacticdef{unify \term$_1$ \term$_2$}}
\tacindex{unify}
\label{unify}
...
\begin{Variants}
\item {\tacticdef{unify \term$_1$ \term$_2$ with \ident}}
...
\subsection{\tacticdef{is\_evar \term}}
\tacindex{is\_evar}
\label{isevar}
...
\subsection{\tacticdef{has\_evar \term}}
\tacindex{has\_evar}
\label{hasevar}
...
\subsection{\tacticdef{is\_var \term}}
\tacindex{is\_var}
\label{isvar}
...
\subsection{\tacticdef{reflexivity}}
\label{reflexivity}
\tacindex{reflexivity}
...
\subsection{\tacticdef{decide equality}}
...
\subsection{\tacticdef{compare \term$_1$ \term$_2$}}
\tacindex{compare}
...
\subsection{\tacticdef{simplify\_eq \term}}
...
\begin{Variants}
\item {\tacticdef{simplify\_eq \num}}

  This does the same thing as \texttt{intros until \num} then
\texttt{simplify\_eq \ident} where {\ident} is the identifier for the last
introduced hypothesis.

\item {\tacticdef{simplify\_eq}} \term{} {\tt with} {\bindinglist}

  This does the same as \texttt{simplify\_eq {\term}} but using
  the given bindings to instantiate parameters or hypotheses of {\term}.

\item {\tacticdef{esimplify\_eq \num}}\\
      {\tacticdef{esimplify\_eq \term{} \zeroone{{\tt with} {\bindinglist}}}}
...
\subsection{\tacticdef{dependent rewrite -> \ident}}
...
\begin{Variants}
\item {\tacticdef{dependent rewrite <- {\ident}}}
\tacindex{dependent rewrite <-}
...
\subsection{\tacticdef{functional inversion \ident}}
...
\begin{Variants}
\item {\tacticdef{functional inversion \num}}

  This does the same thing as \texttt{intros until \num} then
  \texttt{functional inversion \ident} where {\ident} is the
  identifier for the last introduced hypothesis.
\item {\tacticdef{functional inversion \ident\ \qualid}}\\
...
\subsection{\tacticdef{quote \ident}}
\tacindex{quote}
...
\begin{Variants}
\item {\tacticdef{quote {\ident} [ \ident$_1$ \dots \ident$_n$ ]}}
...
\subsection{{\tacticdef{classical\_left}} and {\tacticdef{classical\_right}}}
...
\subsection{{\tacticdef{ring}} and {\tacticdef{ring\_simplify \term$_1$ \mbox{\dots} \term$_n$}}}
\tacindex{ring}
...
printed with the {\vernacdef{Print Rings}} command.

\subsection{{\tacticdef{field}}, {\tacticdef{field\_simplify \term$_1$ \mbox{\dots}
  \term$_n$}}, and {\tacticdef{field\_simplify\_eq}}}
\tacindex{field}
...
printed with the {\vernacdef{Print Fields}} command.
...
\subsection[\tt revgoals]{\tacticdef{revgoals\tacindex{revgoals}}}
...
\subsection[\tt shelve]{\tacticdef{shelve\tacindex{shelve}\label{shelve}}}
...
\begin{Variants}
  \item {\tacticdef{shelve\_unifiable}}\tacindex{shelve\_unifiable}
...
\subsection[\tt Unshelve]{\vernacdef{Unshelve\comindex{Unshelve}\label{unshelve}}}
...
\subsection[\tt give\_up]{\tacticdef{give\_up\tacindex{give\_up}}}
