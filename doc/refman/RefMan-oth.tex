...
\subsection[\tt Print {\qualid}.]{\vernacdef{Print {\qualid}.\comindex{Print}}}
...
\begin{Variants}
\item {\vernacdef{Print Term {\qualid}.}}
\comindex{Print Term}\\ 
This is a synonym to {\tt Print {\qualid}} when {\qualid} denotes a
global constant. 

\item {\vernacdef{About {\qualid}.}}
\label{About}
\comindex{About}\\ 
...
\subsection[\tt Print All.]{\vernacdef{Print All.\comindex{Print All}}}
This command displays information about the current state of the
environment, including sections and modules.

\begin{Variants}
\item {\vernacdef{Inspect \num.}}\comindex{Inspect}\\
This command displays the {\num} last objects of the current
environment, including sections and modules.
\item {\vernacdef{Print Section {\ident}.}}\comindex{Print Section}\\
...
% Discontinued
%% \item {\vernacdef{Print.}}\comindex{Print}\\
...
\subsection[\tt Unset {\rm\sl flag}.]{\vernacdef{Unset {\rm\sl flag}.\comindex{Unset}}}
This command switches {\rm\sl flag} off. The original state of {\rm\sl flag}
is restored when the current module ends.

\begin{Variants}
\item {\vernacdef{Local Unset {\rm\sl flag}.\comindex{Local Unset}}}\\
This command switches {\rm\sl flag} off. The original state of {\rm\sl flag}
is restored when the current \emph{section} ends.
\item {\vernacdef{Global Unset {\rm\sl flag}.\comindex{Global Unset}}}\\
...
\subsection[\tt Test {\rm\sl flag}.]{\vernacdef{Test {\rm\sl flag}.\comindex{Test}}}
This command prints whether {\rm\sl flag} is on or off.

\subsection[\tt Set {\rm\sl option} {\rm\sl value}.]{\vernacdef{Set {\rm\sl option} {\rm\sl value}.\comindex{Set}}}
This command sets {\rm\sl option} to {\rm\sl value}. The original value of
{\rm\sl option} is restored when the current module ends.

\begin{Variants}
\item {\vernacdef{Local Set {\rm\sl option} {\rm\sl value}.\comindex{Local Set}}}
This command sets {\rm\sl option} to {\rm\sl value}. The original value of
{\rm\sl option} is restored at the end of the module.
\item {\vernacdef{Global Set {\rm\sl option} {\rm\sl value}.\comindex{Global Set}}}
This command sets {\rm\sl option} to {\rm\sl value}. The original value of
...
\subsection[\tt Unset {\rm\sl option}.]{\vernacdef{Unset {\rm\sl option}.\comindex{Unset}}}
This command resets {\rm\sl option} to its default value.

\begin{Variants}
\item {\vernacdef{Local Unset {\rm\sl option}.\comindex{Local Unset}}}\\
This command resets {\rm\sl option} to its default value. The original state of {\rm\sl option}
is restored when the current \emph{section} ends.
\item {\vernacdef{Global Unset {\rm\sl option}.\comindex{Global Unset}}}\\
...
\subsection[\tt Test {\rm\sl option}.]{\vernacdef{Test {\rm\sl option}.\comindex{Test}}}
...
The general commands for tables are {\tt Add {\rm\sf table} {\rm\sl
  ...
  {\vernacdef{Print Table \nterm{table}}}.

\subsection[\tt Print Options.]{\vernacdef{Print Options.\comindex{Print Options}}}
This command lists all available flags, options and tables.

\begin{Variants}
\item {\vernacdef{Print Tables}}.\comindex{Print Tables}\\
This is a synonymous of {\tt Print Options.}
\end{Variants}

\section{Requests to the environment}

\subsection[\tt Check {\term}.]{\vernacdef{Check {\term}.\label{Check}
\comindex{Check}}}
...
\begin{Variants}
\item {\vernacdef{\selector: Check {\term}}}.\\ %TODO
specifies on which subgoal to perform typing (see
  Section~\ref{tactic-syntax}).
\end{Variants}


\subsection[\tt Eval {\rm\sl convtactic} in {\term}.]{\vernacdef{Eval {\rm\sl convtactic} in {\term}.\comindex{Eval}}}
...
\subsection[\tt Compute {\term}.]{\vernacdef{Compute {\term}.\comindex{Compute}}}
...
\subsection[\tt Extraction \term.]{\vernacdef{Extraction \term.\label{ExtractionTerm}
\comindex{Extraction}}}
...
\begin{Variants}
\item {\vernacdef{Recursive Extraction {\qualid$_1$} \ldots{} {\qualid$_n$}{\tt .}}}\\
...
\subsection[\tt Print Assumptions {\qualid}.]{\vernacdef{Print Assumptions {\qualid}.\comindex{Print Assumptions}}}
...
\newcommand{\termpatternorstr}{\nterm{search\_term}}

\begin{Variants}
\item {\vernacdef{Search {\str}.}}
...
\item {\vernacdef{Search {\str}\%{\delimkey}.}}
...
\item {\vernacdef{Search {\termpattern}.}}
...
\item {\vernacdef{\selector: Search \nelist{\zeroone{-}{\termpatternorstr}}{}.}} %TODO
...
current {\tt Search} was obtained with command {\vernacdef{SearchAbout \qualid}}. For
...
\subsection[\tt SearchHead {\term}.]{\vernacdef{SearchHead {\term}.\comindex{SearchHead}}}
...
\begin{Variants}
\item
{\vernacdef{SearchHead {\term} {\tt inside} {\module$_1$} \ldots{} {\module$_n$}{\tt .}}}

This restricts the search to constructions defined in modules
{\module$_1$} \ldots{} {\module$_n$}.

\item {\vernacdef{SearchHead {\term} {\tt outside} {\module$_1$} \ldots{} {\module$_n$}{\tt .}}}
...
\item {\vernacdef{\selector: SearchHead {\term}.}}
...
\subsection[\tt SearchPattern {\termpattern}.]{\vernacdef{SearchPattern {\term}.\comindex{SearchPattern}}}
...
\begin{Variants}
\item {\vernacdef{SearchPattern {\term} inside
{\module$_1$} \ldots{} {\module$_n$}.}}

This restricts the search to constructions defined in modules
{\module$_1$} \ldots{} {\module$_n$}.

\item {\vernacdef{SearchPattern {\term} outside {\module$_1$} \ldots{} {\module$_n$}.}}

This restricts the search to constructions not defined in modules
{\module$_1$} \ldots{} {\module$_n$}.

\item {\vernacdef{\selector: SearchPattern {\term}.}} %TODO
...
\subsection[\tt SearchRewrite {\term}.]{\vernacdef{SearchRewrite {\term}.\comindex{SearchRewrite}}}
...
\begin{Variants}
\item {\vernacdef{SearchRewrite {\term} inside
{\module$_1$} \ldots{} {\module$_n$}.}}

This restricts the search to constructions defined in modules
{\module$_1$} \ldots{} {\module$_n$}.

\item {\vernacdef{SearchRewrite {\term} outside {\module$_1$} \ldots{} {\module$_n$}.}}

This restricts the search to constructions not defined in modules
{\module$_1$} \ldots{} {\module$_n$}.

\item {\vernacdef{\selector: SearchRewrite {\term}.}}
...
{\vernacdef{Add Search Blacklist {\str}}}.
...
The default blacklisted substrings are {\tt 
  "\_subproof" "Private\_"}. The command {\vernacdef{Remove Search Blacklist
  {\str}}} allows expunging this blacklist.
...
\subsection[\tt Locate {\qualid}.]{\vernacdef{Locate {\qualid}.\comindex{Locate}
\label{Locate}}}
...
\begin{Variants}
\item {\vernacdef{Locate Term {\qualid}.}}\comindex{Locate Term}\\
  As {\tt Locate} but restricted to terms.

\item {\vernacdef{Locate Module {\qualid}.}}
  As {\tt Locate} but restricted to modules.

\item {\vernacdef{Locate Ltac {\qualid}.}}\comindex{Locate Ltac}\\
...
\subsection[\tt Load {\ident}.]{\vernacdef{Load {\ident}.\comindex{Load}\label{Load}}}
...
\begin{Variants}
\item {\vernacdef{Load {\str}.}}\label{Load-str}\\
  ...
  extension is specified, \Coq\ will use the default extension {\tt
    .v}
\item {\vernacdef{Load Verbose {\ident}.}},
  {\vernacdef{Load Verbose {\str}}}\\
...
\subsection[\tt Require {\qualid}.]{\vernacdef{Require {\qualid}.\label{Require}
\comindex{Require}}}
...
\begin{Variants}
\item {\vernacdef{Require Import {\qualid}.}} \comindex{Require Import}
...
\item {\vernacdef{Require Export {\qualid}.}}
...
\item {\vernacdef{Require \zeroone{\argchoice{Import,Export}} {\qualid}$_1$ {\ldots} {\qualid}$_n${\tt .}}}
...
\item {\vernacdef{From {\dirpath} Require {\qualid}.}}
...
\subsection[\tt Print Libraries.]{\vernacdef{Print Libraries.\comindex{Print Libraries}}}
...
\subsection[\tt Declare ML Module {\str$_1$} \ldots {\str$_n$}.]{\vernacdef{Declare ML Module {\str$_1$} .. {\str$_n$}.\comindex{Declare ML Module}}}
...
\begin{Variants}
\item {\vernacdef{Local Declare ML Module {\str$_1$} \ldots {\str$_n$}.}}\\
...
\subsection[\tt Print ML Modules.]{\vernacdef{Print ML Modules.\comindex{Print ML Modules}}}
...
\subsection[\tt Pwd.]{\vernacdef{Pwd.\comindex{Pwd}\label{Pwd}}}
This command displays the current working directory.

\subsection[\tt Cd {\str}.]{\vernacdef{Cd {\str}.\comindex{Cd}}}
...
\subsection[\tt Add LoadPath {\str} as {\dirpath}.]{\vernacdef{Add LoadPath {\str} as {\dirpath}.\comindex{Add LoadPath}\label{AddLoadPath}}}
...
\begin{Variants}
\item {\vernacdef{Add LoadPath {\str}.}}\\
Performs as {\tt Add LoadPath {\str} as {\dirpath}} but for the empty directory path.
\end{Variants}

\subsection[\tt Add Rec LoadPath {\str} as {\dirpath}.]{\vernacdef{Add Rec LoadPath {\str} as {\dirpath}.\comindex{Add Rec LoadPath}\label{AddRecLoadPath}}}
...
\begin{Variants}
\item {\vernacdef{Add Rec LoadPath {\str}.}}\\
Works as {\tt Add Rec LoadPath {\str} as {\dirpath}} but for the empty logical directory path.
\end{Variants}

\subsection[\tt Remove LoadPath {\str}.]{\vernacdef{Remove LoadPath {\str}.\comindex{Remove LoadPath}}}
This command removes the path {\str} from the current \Coq\ loadpath.

\subsection[\tt Print LoadPath.]{\vernacdef{Print LoadPath.\comindex{Print LoadPath}}}
This command displays the current \Coq\ loadpath.

\begin{Variants}
\item {\vernacdef{Print LoadPath {\dirpath}.}}\\
Works as {\tt Print LoadPath} but displays only the paths that extend the {\dirpath} prefix.
\end{Variants}

\subsection[\tt Add ML Path {\str}.]{\vernacdef{Add ML Path {\str}.\comindex{Add ML Path}}}
...
\subsection[\tt Add Rec ML Path {\str}.]{\vernacdef{Add Rec ML Path {\str}.\comindex{Add Rec ML Path}}}
This command adds the directory {\str} and all its subdirectories 
to the current {\ocaml} loadpath (see
the command {\tt Declare ML Module} in the Section~\ref{compiled}).

\subsection[\tt Print ML Path {\str}.]{\vernacdef{Print ML Path {\str}.\comindex{Print ML Path}}}
...
\subsection[\tt Locate File {\str}.]{\vernacdef{Locate File {\str}.\comindex{Locate
...
\subsection[\tt Locate Library {\dirpath}.]{\vernacdef{Locate Library {\dirpath}.\comindex{Locate Library}\label{Locate Library}}}
...
\subsection[\tt Reset \ident.]{\vernacdef{Reset \ident.\comindex{Reset}}}
...
\subsection[\tt Back.]{\vernacdef{Back.\comindex{Back}}}
...
\subsection[\tt Quit.]{\vernacdef{Quit.\comindex{Quit}}}
This command permits to quit \Coq.

\subsection[\tt Drop.]{\vernacdef{Drop.\comindex{Drop}\label{Drop}}}
...
\subsection[\tt Time \textrm{\textsl{command}}.]{\vernacdef{Time \textrm{\textsl{command}}.\comindex{Time}
\label{time}}}
This command executes the vernacular command \textrm{\textsl{command}}
and display the time needed to execute it.

\subsection[\tt Redirect "\textrm{\textsl{file}}" \textrm{\textsl{command}}.]{\vernacdef{Redirect "\textrm{\textsl{file}}" \textrm{\textsl{command}}.\comindex{Redirect}
\label{redirect}}}
This command executes the vernacular command \textrm{\textsl{command}}, redirecting its output to ``\textrm{\textsl{file}}.out''.

\subsection[\tt Timeout \textrm{\textsl{int}} \textrm{\textsl{command}}.]{\vernacdef{Timeout \textrm{\textsl{int}} \textrm{\textsl{command}}.\comindex{Timeout}
\label{timeout}}}
...
\subsection[\tt Set Default Timeout \textrm{\textsl{int}}.]{\vernacdef{Set
...
\subsection[\tt Unset Default Timeout.]{\vernacdef{Unset Default Timeout.\optindex{Default Timeout}}}

This command turns off the use of a default timeout.

\subsection[\tt Test Default Timeout.]{\vernacdef{Test Default Timeout.\optindex{Default Timeout}}}

This command displays whether some default timeout has be set or not.

\section{Controlling display}

\subsection[\tt Set Silent.]{\vernacdef{Set Silent.\optindex{Silent}
\label{Begin-Silent}
\index{Silent mode}}}
This command turns off the normal displaying.

\subsection[\tt Unset Silent.]{\vernacdef{Unset Silent.\optindex{Silent}}}
This command turns the normal display on.

\subsection[\tt Set Search Output Name Only.]{\vernacdef{Set Search Output Name Only.}\optindex{Search Output Name Only}
...
\subsection[\tt Unset Search Output Name Only.]{\vernacdef{Unset Search Output Name Only.}\optindex{Search Output Name Only}}
This command turns type display in search results back on.

\subsection[\tt Set Printing Width {\integer}.]{\vernacdef{Set Printing Width {\integer}.\optindex{Printing Width}}}
\label{SetPrintingWidth}
This command sets which left-aligned part of the width of the screen
is used for display. 

\subsection[\tt Unset Printing Width.]{\vernacdef{Unset Printing Width.\optindex{Printing Width}}}
...
\subsection[\tt Test Printing Width.]{\vernacdef{Test Printing Width.\optindex{Printing Width}}}
This command displays the current screen width used for display.

\subsection[\tt Set Printing Depth {\integer}.]{\vernacdef{Set Printing Depth {\integer}.\optindex{Printing Depth}}}
...
\subsection[\tt Unset Printing Depth.]{\vernacdef{Unset Printing Depth.\optindex{Printing Depth}}}
This command resets the nesting depth of the formatter used for
pretty-printing to its default value (at the
time of writing this documentation, the default value is 50).

\subsection[\tt Test Printing Depth.]{\vernacdef{Test Printing Depth.\optindex{Printing Depth}}}
...
\subsection[{\tt Opaque} \qualid$_1$ {\ldots} \qualid$_n${\tt .}]{{\vernacdef{Opaque \qualid$_1$ {\ldots} \qualid$_n${\tt .}}}\comindex{Opaque}\label{Opaque}}
...
current file, unless the variant {\vernacdef{Global Opaque \qualid$_1$ {\ldots}
\qualid$_n$}} is used.
...
\subsection[{\tt Transparent} \qualid$_1$ {\ldots} \qualid$_n${\tt .}]{{\vernacdef{Transparent \qualid$_1$ {\ldots} \qualid$_n${\tt .}}}\comindex{Transparent}\label{Transparent}}
...
\subsection{{\vernacdef{Strategy {\it level} {\tt [} \qualid$_1$ {\ldots} \qualid$_n$
...
\subsection{{\vernacdef{Print Strategy \qualid{\tt .}}}\comindex{Print Strategy}\label{PrintStrategy}}
...
\begin{Variants}
\item {\vernacdef{Print Strategies}}\comindex{Print Strategies}\\
  Print all the currently non-transparent strategies.
\end{Variants}

\subsection{\vernacdef{Declare Reduction \ident\ := {\rm\sl convtactic}.}}
...
\subsection{{\vernacdef{Local \nterm{command}}}, {\vernacdef{Global \nterm{command}}}
\comindex{Local}
\comindex{Global}
}
