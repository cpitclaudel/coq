...
\begin{itemize}
\item {\tacticdef{discrR}} \tacindex{discrR}
...
\item {\tacticdef{split\_Rabs}} allows unfolding the {\tt Rabs} constant and splits
...
\item {\tacticdef{split\_Rmult}} splits a condition that a product is
