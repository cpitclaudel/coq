...
\begin{description}
\item {\vernacdef{Extraction \qualid.}} ~\par
  Extraction of a constant or module in the \Coq\ toplevel.

\item {\vernacdef{Recursive Extraction \qualid$_1$ \dots\ \qualid$_n$.}} ~\par
...
\begin{description}
\item {\vernacdef{Extraction "{\em file}"
...
\item {\vernacdef{Extraction Library \ident.}} ~\par
...
\item {\vernacdef{Recursive Extraction Library \ident.}} ~\par
  Extraction of the \Coq\ library {\tt\ident.v} and all other modules 
  {\tt\ident.v} depends on. 

\item {\vernacdef{Separate Extraction
      \qualid$_1$ \dots\ \qualid$_n$.}} ~\par
  Recursive extraction of all the globals (or modules) \qualid$_1$ \dots\
...
\begin{description}
\item {\vernacdef{Extraction Language Ocaml.}}
\item {\vernacdef{Extraction Language Haskell.}}
\item {\vernacdef{Extraction Language Scheme.}}
\end{description}
...
\item \optindex{Extraction Optimize} {\vernacdef{Unset Extraction Optimize.}}
...
{\vernacdef{Set Extraction Conservative Types.}}
...
{\vernacdef{Set Extraction KeepSingleton.}}
...
\item \optindex{Extraction AutoInline} {\vernacdef{Unset Extraction AutoInline.}}
...
{\vernacdef{Extraction \argchoice{Inline,NoInline} \qualid$_1$ \dots\ \qualid$_n$.}}
...
{\vernacdef{Print Extraction Inline.}}
...
{\vernacdef{Reset Extraction Inline.}}
...
\item \comindex{Extraction Implicit}
 {\vernacdef{Extraction Implicit \qualid\ [ \ident$_1$ \dots\ \ident$_n$ ].}}
...
\begin{description}
\item \optindex{Extraction SafeImplicits} {\vernacdef{Unset Extraction SafeImplicits.}}
...
\begin{description}
\item{\vernacdef{Extract Constant \qualid\ => \str.}} ~\par
  Give an ML extraction for the given constant.
  The \str\ may be an identifier or a quoted string.
\item{\vernacdef{Extract Inlined Constant \qualid\ => \str.}} ~\par
...
\begin{description}
\item{\vernacdef{Extract Constant \qualid\ \str$_1$ \dots\ \str$_n$ => \str.}}
\end{description}
...
\begin{description}
\item{\vernacdef{Extract Inductive \qualid\ => \str\ [ \str\ \dots\ \str\ ] {\it optstring}.}}\par
...
\begin{description}
\item{\vernacdef{Extraction Blacklist \ident\ \dots\ \ident.}} ~\par
  Instruct the extraction to avoid using these names as filenames
  for extracted code. 
\item{\vernacdef{Print Extraction Blacklist.}} ~\par
  Show the current list of filenames the extraction should avoid.
\item{\vernacdef{Reset Extraction Blacklist.}} ~\par
