...
\subsubsection{\vernacdef{Axiom {\ident} : {\term} .}
\comindex{Axiom}
\label{Axiom}}
...
\item \comindex{Parameter}\comindex{Parameters}
  {\vernacdef{Parameter {\ident} : {\term}.}} \\
  Is equivalent to {\tt Axiom {\ident} : {\term}}

\item {\vernacdef{Parameter {\ident$_1$} {\ldots} {\ident$_n$} {\tt :} {\term}.}}\\
...
\item {\vernacdef{Local Axiom {\ident} : {\term}.}}\\
...
\item \comindex{Conjecture}
  {\vernacdef{Conjecture {\ident} : {\term}.}}\\
  Is equivalent to {\tt Axiom {\ident} : {\term}}.
\end{Variants}
...
\subsubsection{\vernacdef{Variable {\ident} : {\term}}.
\comindex{Variable}
\comindex{Variables}
\label{Variable}}
...
\begin{Variants}
\item {\vernacdef{Variable {\ident$_1$} {\ldots} {\ident$_n$} {\tt :} {\term}.}}\\
...
\subsubsection{\vernacdef{Definition {\ident} := {\term}.
\label{Definition}
\comindex{Definition}}}
...
\begin{Variants}
\item {\vernacdef {\tt Definition} {\ident} {\tt :} {\term$_1$} {\tt :=} {\term$_2$}{\tt .}}\\
...
\item {\vernacdef {\tt Definition} {\ident} {\binder$_1$} {\ldots} {\binder$_n$}}
       {\tt :} \term$_1$ {\tt :=} {\term$_2$}{\tt .}\\
...
\subsubsection{\vernacdef{Let {\ident} := {\term}.
\comindex{Let}}}
...
\begin{Variants}
\item {\vernacdef{Let {\ident} : {\term$_1$} := {\term$_2$}.}}
\item {\vernacdef{Let Fixpoint {\ident} \nelist{\fixpointbody}{with} {\tt .}.}}
\item {\vernacdef{Let CoFixpoint {\ident} \nelist{\cofixpointbody}{with} {\tt .}.}}
\end{Variants}
...
\begin{center}
\vernacdef{{\tt Inductive} {\ident} {\binder$_1$}\ldots{\binder$_k$} : {\term} :=
...
\end{coq_example*}
The \vernacdef{{\tt Variant} {\ident} {\binder$_1$}\ldots{\binder$_k$} : {\term} :=}
...
\begin{center}
  \vernacdef{Fixpoint {\ident} {\params} {\tt \{struct}
...
\subsubsection{\vernacdef{Theorem {\ident} \zeroone{\binders} : {\type}.
\comindex{Theorem}}}
...
\begin{Variants} 
\item {\vernacdef{Lemma {\ident} \zeroone{\binders} : {\type}.}}\comindex{Lemma}\\
  {\vernacdef{Remark {\ident} \zeroone{\binders} : {\type}.}}\comindex{Remark}\\
  {\vernacdef{Fact {\ident} \zeroone{\binders} : {\type}.}}\comindex{Fact}\\
  {\vernacdef{Corollary {\ident} \zeroone{\binders} : {\type}.}}\comindex{Corollary}\\
  {\vernacdef{Proposition {\ident} \zeroone{\binders} : {\type}.}}\comindex{Proposition}
...
\item {\vernacdef{Definition {\ident} \zeroone{\binders} : {\type}.}}
...
\item {\vernacdef{Let {\ident} \zeroone{\binders} : {\type}.}}
