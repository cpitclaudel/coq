...
\asubsection{\vernacdef{Coercion {\qualid} : {\class$_1$} >-> {\class$_2$}.}}
\comindex{Coercion}
...
\item {\vernacdef{Local Coercion {\ident} := {\term}}}\comindex{Local Coercion}\\
...
\asubsection{\vernacdef{Identity Coercion {\ident}:{\class$_1$} >-> {\class$_2$}.}}
...
\begin{Variants}
\item {\vernacdef{Local Identity Coercion {\ident}:{\ident$_1$} >-> {\ident$_2$}.}} \\
Idem but locally to the current section.

\item {\vernacdef{SubClass {\ident} := {\type}.}} \\
\comindex{SubClass}
 If {\type} is a class
...
\item {\vernacdef{Local SubClass {\ident} := {\type}.}} \\
...
\asubsection{\vernacdef{Print Classes.}}
\comindex{Print Classes}
Print the list of declared classes in the current context.

\asubsection{\vernacdef{Print Coercions.}}
\comindex{Print Coercions}
Print the list of declared coercions in the current context.

\asubsection{\vernacdef{Print Graph.}}
\comindex{Print Graph}
Print the list of valid coercion paths in the current context.

\asubsection{\vernacdef{Print Coercion Paths {\class$_1$} {\class$_2$}.}}
...
\asubsection{\vernacdef{Set Printing Coercions.}}
...
Conversely, to skip the printing of coercions, use
 {\vernacdef{Unset Printing Coercions}}.
By default, coercions are not printed.

\asubsection{\vernacdef{Add Printing Coercion {\qualid}.}}
