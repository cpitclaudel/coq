...
\subsection{\vernacdef{Class {\ident} {\binder$_1$ \ldots~\binder$_n$}
...
\begin{Variants}
\item \label{SingletonClass} {\vernacdef{Class {\ident} {\binder$_1$ \ldots \binder$_n$}
...
\item \label{ExistingClass} {\vernacdef{Existing Class {\ident}.}\comindex{Existing Class}}
  This variant declares a class a posteriori from a constant or
  inductive definition. No methods or instances are defined.
\end{Variants}

\subsection{\vernacdef{Instance {\ident} {\binder$_1$ \ldots \binder$_n$} :
  {Class} {\term$_1$ \ldots \term$_n$} \zeroone{\textit{priority}}
  := \{ \field$_1$ := \nterm{b}$_1$ ; \ldots ; \field$_i$ := \nterm{b}$_i$ \}}}
\comindex{Instance}
\label{Instance}

The \texttt{Instance} command is used to declare a type class instance
named {\ident} of the class \emph{Class} with parameters {\term$_1$} to {\term$_n$} and
fields {\tt \nterm{b}$_1$} to {\tt \nterm{b}$_i$}, where each field must be a declared
...
\subsection{\vernacdef{Existing Instance {\ident} \zeroone{\textit{priority}}}}
...
\begin{Variants}
\item {\vernacdef{Existing Instances {\ident}$_1$ \ldots {\ident}$_n$
  \zeroone{\textit{priority}}}}
  \comindex{Existing Instances}
  With this command, several existing instances can be declared at once.
\end{Variants}

\subsection{\vernacdef{Context {\binder$_1$ \ldots \binder$_n$}}}
\comindex{Context}
\label{Context}
...
\subsection{\vernacdef{Typeclasses Transparent \ident$_1$ \ldots \ident$_n$}, \vernacdef{Typeclasses Opaque \ident$_1$ \ldots \ident$_n$}}
...
\subsection{\vernacdef{Typeclasses eauto := \zeroone{debug} \zeroone{\argchoice{dfs,bfs} \emph{depth}}}}
...
\subsection{\vernacdef{Set Refine Instance Mode}}
